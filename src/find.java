...
//	        UpdateTable();
	...
	public find() {
		...
		txtSearch.setBounds(606, 217, 375, 50);
		contentPane.add(txtSearch);
		txtSearch.setColumns(10);
		
		JButton btnNewButton1 = new JButton(" ADD QUANTITY");
		...
		btnNewButton1.setBounds(296, 220, 123, 42);
		contentPane.add(btnNewButton1);
		
		JButton btnIssueQuantity = new JButton("ISSUE QUANTITY");
		btnIssueQuantity.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IssueQuantity is=new IssueQuantity();
				is.show();
			}
		});
		btnIssueQuantity.setBounds(442, 220, 123, 42);
		contentPane.add(btnIssueQuantity);
		...
		update.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				 String value1=item.getText();
				    String value2=BSQPartNumber.getText();
				    String value3=PartNumber.getText();
				    String value4=Description.getText();
				    String value5=MountingType.getText();
				    String value6=Manufacturer.getText();
				    String value7=Rack.getText();
				    String value8=BoxNumber.getText();
				    String value9=Project.getText();
				    String value10=QuantityType.getText();
				    String value11=BalancedQunatity.getText();

				    String sql="update table1 set item='"+value1+"',PartNumber='"+value3+"',Description='"+value4+"'," +
				            "MountingType='"+value5+"',Manufacturer='"+value6+"',Rack='"+value7+"',BoxNumber='" +
				            ""+value8+"',Project='"+value9+"',QuantityType='"+value10+"'," +
				            "BalancedQuantity='"+value11+"'where BSQPartNumber='" +value2+"'";
				    ...
				    try{
				    	...
				    	JOptionPane.showMessageDialog(null, "cant found in database","error",JOptionPane.ERROR_MESSAGE);
		...
		update.setBounds(578, 616, 117, 35);
		...
		delete.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String value2=BSQPartNumber.getText();
			    String sql="delete from table1 where BSQPartNumber='"+value2+"'";
			    try{
			        connectionClass con = new connectionClass();
			        Connection connectionDB = con.getConnection();
		...
		delete.setBounds(578, 663, 117, 36);
...
//				        UpdateTable();
				    	...
				    	JOptionPane.showMessageDialog(null, "enter correct BsqPartNumber","error",JOptionPane.ERROR_MESSAGE);

				    }

			}
		});
		add.setBounds(578, 711, 117, 36);
		contentPane.add(add);
		...
		lblNewLabel_6.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				table();
				item.setText(null);
			    BSQPartNumber.setText(null);
			    PartNumber.setText(null);
			    Description.setText(null);
			    MountingType.setText(null);
			    Manufacturer.setText(null);
			    Rack.setText(null);
			    BoxNumber.setText(null);
			    Project.setText(null);
			    QuantityType.setText(null);
			    BalancedQunatity.setText(null);
				
			}
		});
		lblNewLabel_6.setBounds(598, 774, 68, 43);
		contentPane.add(lblNewLabel_6);
		image("/icons/refresh.png",lblNewLabel_6);
